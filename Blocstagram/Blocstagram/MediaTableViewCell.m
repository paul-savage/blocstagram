...
- (void)layoutSubviews {
    ...
    self.usernameAndCaptionLabelHeightConstraint.constant = (0) ? 0 : usernameLabelSize.height + 20;
    self.commentLabelHeightConstraint.constant = (0) ? 0 : commentLabelSize.height + 20;
