    ...
    [AVCaptureDevice requestAccessForMediaType:AVMediaTypeVideo completionHandler:^(BOOL granted)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (granted)
            {
                ...
                if (!input)
                {
                    [self raiseAlertWitheTitle:error.localizedDescription message:error.localizedRecoverySuggestion];
                }
                else
                {
            ...
            {
                [self raiseAlertWitheTitle:NSLocalizedString(@"Camera Permission Denied", @"camera permission denied title")
...
- (void)raiseAlertWitheTitle:(NSString *)title message:(NSString *)message
{
