...
- (UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell configureWithSize:thumbnailEdgeSize filterImage:self.filterImages[indexPath.row] filterTitle:self.filterTitles[indexPath.row]];
...
- (void)addFiltersToQueue
{
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        if (dotScreenFilter)
        {
            [dotScreenFilter setValue:sourceCIImage forKey:kCIInputImageKey];
            [self addCIImageToCollectionView:dotScreenFilter.outputImage withFilterTitle:NSLocalizedString(@"Dotty", @"Dotty Filter")];
        }
    }];
